...
use ehdb_reference::{
    ...
    ResolveSystemModuleRequest, RetrievalOutcome, RetrieveContextRequest, Routed, SegmentGcPolicy,
    ServedBy, ShardOwnership, VectorPrimaryInput, DEFAULT_LOCAL_REFERENCE_NAMESPACE,
